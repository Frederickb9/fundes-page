...
import { MapPin, Phone, Mail, Clock, Globe, Link } from 'lucide-react';
  ...
  return (
    <footer id="contacto" className="bg-navy text-white/70 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 relative z-10">
            ...
            <div className="flex gap-3">
              {[
                ...
                <motion.a key={label} href={href} aria-label={label}
                  className="w-8 h-8 border border-white/10 flex items-center justify-center text-white/40 hover:text-gold hover:border-gold/40 transition-colors"
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/8 py-6 flex flex-col md:flex-row gap-4 items-center justify-between">
