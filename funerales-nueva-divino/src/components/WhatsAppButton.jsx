  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        animate={showTooltip ? { opacity: 1, x: 0 } : { opacity: 0, x: 12 }}
        transition={{ delay: showTooltip ? 1.5 : 0, duration: 0.4 }}
        className="relative bg-charcoal text-white font-sans text-xs px-3 py-1.5 whitespace-nowrap shadow-elegant pointer-events-none">
      ...
      <div className="relative">
        ...
        <motion.a
          ...
          className="relative w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-lg bg-[#25D366]"
