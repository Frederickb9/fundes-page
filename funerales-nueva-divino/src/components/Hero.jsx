...
export default function Hero() {
  return (
    <section id="inicio" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-navy">
      ...
      {/* Degradado top + bottom para legibilidad del nav y stats */}
      ...
      <div className="absolute top-0 left-0 right-0 h-0.5 bg-gold-gradient opacity-80 z-10" />

      {/* Brillo radial dorado central */}
