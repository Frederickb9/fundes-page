  ...
  return (
    <section id="inicio" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden"
      ...
      <div className="relative z-10 text-center px-5 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <motion.p variants={fadeUp} initial="hidden" animate="show" custom={0.1}
        ...
        <motion.p variants={fadeUp} initial="hidden" animate="show" custom={0.65}
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="show" custom={0.85}
